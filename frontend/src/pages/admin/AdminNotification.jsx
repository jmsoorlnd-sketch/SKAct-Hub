      ...
      <div className="max-w-5xl mx-auto px-4 py-5">
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-3 hover:shadow-lg transition-all">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="w-11 h-11 bg-linear-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-sm">
            ...
            <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-3 hover:shadow-lg transition-all">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="w-11 h-11 bg-linear-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center shadow-sm">
            ...
            {notifications.map((n) => {
              ...
              return (
                <div
                  ...
                  className={`relative bg-white rounded-2xl shadow-md border transition-all cursor-pointer hover:shadow-lg hover:-translate-y-0.5 ${
                    n.seen
                      ? "border-slate-200"
                ...
                >
                  <div className="p-3 flex items-start gap-3">
                    <div
                      className={`w-11 h-11 bg-linear-to-br ${color} rounded-2xl flex items-center justify-center shadow-sm shrink-0`}
                    >
