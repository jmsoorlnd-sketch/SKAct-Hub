      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-4 hover:shadow-xl transition-all">
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="w-12 h-12 bg-linear-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-sm">
            ...
            <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-4 hover:shadow-xl transition-all">
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="w-12 h-12 bg-linear-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center shadow-sm">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-5 text-center">
            ...
            {notifications.map((n) => {
              ...
              return (
                <div
                  ...
                  className={`relative bg-white rounded-2xl shadow-md border transition-all cursor-pointer hover:shadow-xl hover:-translate-y-0.5 ${
                    n.seen
                      ? "border-slate-200"
                ...
                >
                  <div className="p-4 flex items-start gap-4">
                    <div
                      className={`w-12 h-12 bg-linear-to-br ${color} rounded-3xl flex items-center justify-center shadow-sm shrink-0`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-3 mb-2">
                        <div>
                          ...
                          <h3 className="mt-2 font-semibold text-slate-900 text-base leading-tight">
