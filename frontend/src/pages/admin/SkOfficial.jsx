            ...
            <>
              ...
              <div className="bg-white rounded-2xl shadow-lg border-2 border-slate-200 p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <select
                    className="px-4 py-2.5 border-2 border-slate-200 rounded-xl text-sm font-semibold focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white transition-all appearance-none cursor-pointer"
